...
PARAM$finalmodel$learning_rate <- 0.109486201785213
PARAM$finalmodel$feature_fraction <- 0.979641811260281
PARAM$finalmodel$min_data_in_leaf <- 1511
PARAM$finalmodel$num_leaves <- 886
